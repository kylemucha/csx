...
// runInOrder should execute the functions in order, with the corresponding numbers in milliseconds 
// being the time to wait from the previous invocation. For example -
